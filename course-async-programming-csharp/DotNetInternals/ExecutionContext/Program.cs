...
public static class Program
{
	...
	public static async Task Main()
	{
		...
		var mainThreadExecutionContext = System.Threading.ExecutionContext.Capture() ?? throw new InvalidOperationException("ExecutionContext only null when suppressed");
		...
		var thread = new Thread(() =>
		{
			...
			System.Threading.ExecutionContext.Run(mainThreadExecutionContext, _ =>
			{
