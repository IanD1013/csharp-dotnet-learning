...
namespace Cmd._2_OutputFromQueries;
...
public class ProjectingResults : QueryRunner
{
    ...
    #region 1. GETTING A SINGLE PROPERTY FROM THE MODEL CLASS
    ...
    #region 2. GETTING RESULTS AS AN ANONYMOUS TYPE
    ...
    #region 3. PROJECTING TO A VALUE TUPLE
    ...
    #region 4. PROJECTING TO ANOTHER TYPE
    ...
    #region 5. MATERIALIZE PROJECTED RESULTS
