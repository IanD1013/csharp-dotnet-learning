...
// The Add* API expects an IConfiguration that's named "WidgetOptions".
...
// The Add* API expects a string that represents the path to map to the "WidgetOptions" object.
builder.Services.AddWidgetServices(
...
// The Add* API expects an options delegate (Action<WidgetOptions>) that's used to override option values.
builder.Services.AddWidgetServices(
