...
public sealed class ExampleApp
{
    public void Run()
    {
        ...
        static void PrintConstructorInfo(object objectToInspect)
        {
            ...
            var constructors = objectToInspect.GetType()
                .GetConstructors(
        ...
        static void PrintFieldInfo(object objectToInspect)
        {
            ...
            var fields = objectToInspect.GetType()
                .GetFields(
                    BindingFlags.Instance |
                    BindingFlags.Public |
                    BindingFlags.NonPublic);
        ...
        static void PrintPropertyInfo(object objectToInspect)
        {
            ...
            var properties = objectToInspect.GetType()
                .GetProperties(
                    BindingFlags.Instance |
                    BindingFlags.Public |
                    BindingFlags.NonPublic);
        ...
        static void PrintMethodInfo(object objectToInspect)
        {
            ...
            var methods = objectToInspect.GetType()
                .GetMethods(
                    BindingFlags.Instance |
                    BindingFlags.Public |
                    BindingFlags.NonPublic);
        ...
        static void AskInvokeMethod(object objectToInspect)
        {
            ...
            var method = objectToInspect.GetType()
                .GetMethod(
                    methodName,
                    BindingFlags.Instance |
                    BindingFlags.Public |
