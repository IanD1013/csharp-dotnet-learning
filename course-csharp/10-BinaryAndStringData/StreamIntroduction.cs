...
public sealed class StreamIntroduction
{
    public void RunExample()
    {
        ...
        Console.WriteLine($"Stream Position Before: {memoryStream.Position}"); // 0
        Console.WriteLine($"  Stream Length Before: {memoryStream.Length}");   // 0
        Console.WriteLine($"Stream Capacity Before: {memoryStream.Capacity}"); // 0
        ...
        Console.WriteLine($"Stream Capacity After: {memoryStream.Capacity}"); // 256
        Console.WriteLine();
