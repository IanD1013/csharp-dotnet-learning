public class AsyncAwait
{
    public async Task RunExample()
    {
        ...
        // Calling NotActuallyAsync...
        // Entering NotActuallyAsync...
        // Exiting NotActuallyAsync...
        // awaiting NotActuallyAsync...
        // Finished awaiting NotActuallyAsync.

        ///////////////////////////////////////////////////////////////////////////
        async Task LeverageTaskYield()
        {
            Console.WriteLine("Entering LeverageTaskYield...");
            await Task.Yield(); // this will allow the scheduler to surrender control back to allow something else to execute
        ...
        async Task TestCatchingExceptions()
        {
            ...
            {
                //await ThisIsATask();
                // the only reason above works is because we are awaiting on methods 
                // that are async and have a Task return type.
...
// recommend that whenever you have an async void, you need to have a try-catch
// wrapped around it, no matter what