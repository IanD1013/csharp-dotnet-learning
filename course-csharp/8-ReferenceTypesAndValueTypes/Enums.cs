public sealed class Enums
{
    public void RunExample()
    {
        ...
        Console.WriteLine($"Enum Value Directly: {DaysOfWeek.Monday}");     // this will print "Monday"
        Console.WriteLine($"Enum Value Casted: {(int)DaysOfWeek.Monday}");  // this will print "1"
        ...
        {
            Console.WriteLine($"Enum Value: {(int)day}"); // print 0-6, if no (int) casting then will be strings
        }
